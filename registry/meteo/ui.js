...
window.PandaAddons.meteo = (function () {
  ...
  function ensureCss(){if(document.getElementById('wxUiCss'))return;const s=document.createElement('style');s.id='wxUiCss';s.textContent=CSS;document.head.appendChild(s);}
