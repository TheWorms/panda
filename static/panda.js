...
let state={installed:[],hidden:[],order:[],railOn:false,lockEnabled:true,autolock:0,theme:"dark",ntp:true,names:{},catOrder:[],vkb:true,agCals:{},radioFav:[],timers:[],transFav:[],delMode:false,timerSound:'',appCat:{},catCustom:{},catNames:{},fontScale:100,browserPw:false,iconStyle:'tabler',wifiInd:true,btInd:true,clockFmt:'24h',clockSec:false,dateFmt:'long',catHidden:[],storeCheck:'open',storeUrl:'',storeToken:'',font:'system'};
...
const ICMAPS={"tabler": {"📚": "books", "🛰": "satellite", "💾": "database-export", "⌨": "keyboard", "🗂": "git-fork", "🌐": "world", "📆": "calendar", "🌙": "moon", "📰": "news", "🟢": "heartbeat", "🥘": "tools-kitchen-2", "🌱": "plant-2", "🎮": "device-gamepad-2", "🌤": "cloud", "☁": "cloud", "🧮": "calculator", "⏱": "clock", "📅": "calendar-event", "📖": "book-2", "📄": "file-text", "🪵": "logs", "🐳": "brand-docker", "💶": "currency-euro", "🌊": "ripple", "🧊": "snowflake", "📺": "device-tv", "🎵": "music", "🛡": "shield", "🛒": "shopping-cart", "✨": "sparkles", "📊": "chart-line", "🐜": "receipt", "🚆": "train", "📸": "brand-instagram", "🖥": "server", "📻": "radio", "📡": "antenna", "📦": "package", "🗑": "trash", "⚙": "settings", "📁": "folder", "✕": "x", "⚠": "alert-triangle", "✓": "check", "🍽": "tools-kitchen-2", "🔔": "bell", "🖼": "photo", "🎬": "movie", "⭐": "star", "🏠": "home", "🏷": "tag", "👥": "users", "🔍": "search", "📶": "antenna-bars-5", "🔵": "point", "✅": "circle-check", "📃": "file", "🔀": "arrows-shuffle", "📥": "download", "📍": "map-pin", "🔊": "volume", "🎤": "microphone", "🧩": "puzzle", "🎉": "confetti", "🧺": "basket", "🔒": "lock", "⬆": "arrow-up", "🔴": "point", "🚏": "bus-stop", "💿": "disc", "📋": "clipboard", "✗": "x", "🍳": "egg-fried", "🧰": "tools", "📝": "edit", "🚫": "ban", "📂": "folder-open", "📕": "book", "☆": "star", "🎛": "adjustments", "🔇": "volume-off", "🔗": "link", "📴": "device-mobile-off", "⚫": "point", "⚪": "circle", "🚉": "building-arch", "🚶": "walk", "🏦": "building-bank", "💳": "credit-card", "👤": "user", "⛶": "maximize", "🎼": "music", "❓": "help", "🚨": "urgent", "📈": "chart-line", "🎨": "palette", "🔐": "lock", "🔑": "key", "✏": "pencil", "🔈": "volume", "♪": "music", "➕": "plus", "▶": "player-play", "ℹ": "info-circle"}, "bootstrap": {"📚": "book", "🛰": "broadcast-pin", "💾": "device-hdd", "⌨": "keyboard", "🗂": "diagram-3", "🌐": "globe", "📆": "calendar3", "🌙": "moon", "📰": "newspaper", "🟢": "heart-pulse", "🥘": "egg-fried", "🌱": "flower1", "🎮": "controller", "🌤": "cloud-sun", "☁": "cloud", "🧮": "calculator", "⏱": "stopwatch", "📅": "calendar-event", "📖": "book-half", "📄": "file-text", "🪵": "card-list", "🐳": "box-seam", "💶": "currency-euro", "🌊": "water", "🧊": "snow", "📺": "tv", "🎵": "music-note-beamed", "🛡": "shield-shaded", "🛒": "cart", "✨": "stars", "📊": "graph-up", "🐜": "receipt", "🚆": "train-front", "📸": "instagram", "🖥": "pc-display", "📻": "broadcast", "📡": "broadcast-pin", "📦": "box", "🗑": "trash", "⚙": "gear", "📁": "folder", "✕": "x", "⚠": "exclamation-triangle", "✓": "check", "🍽": "egg-fried", "🔔": "bell", "🖼": "image", "🎬": "film", "⭐": "star-fill", "🏠": "house", "🏷": "tag", "👥": "people", "🔍": "search", "📶": "reception-4", "🔵": "circle-fill", "✅": "check-circle", "📃": "file-text", "🔀": "shuffle", "📥": "download", "📍": "geo-alt", "🔊": "volume-up", "🎤": "mic", "🧩": "puzzle", "🎉": "balloon", "🧺": "basket", "🔒": "lock", "⬆": "arrow-up", "🔴": "circle-fill", "🚏": "signpost", "💿": "disc", "📋": "clipboard", "✗": "x", "🍳": "egg-fried", "🧰": "tools", "📝": "pencil-square", "🚫": "slash-circle", "📂": "folder2-open", "📕": "book", "☆": "star", "🎛": "sliders", "🔇": "volume-mute", "🔗": "link", "📴": "phone", "⚫": "circle-fill", "⚪": "circle", "🚉": "train-front", "🚶": "person-walking", "🏦": "bank", "💳": "credit-card", "👤": "person", "⛶": "arrows-fullscreen", "🎼": "music-note-list", "❓": "question-circle", "🚨": "exclamation-octagon", "📈": "graph-up", "🎨": "palette", "🔐": "lock", "🔑": "key", "✏": "pencil", "🔈": "volume-down", "♪": "music-note", "➕": "plus", "▶": "play-fill", "ℹ": "info-circle"}, "fa": {"📚": "s:book", "🛰": "s:satellite-dish", "💾": "s:save", "⌨": "s:keyboard", "🗂": "s:folder-tree", "🌐": "s:globe", "📆": "s:calendar-days", "🌙": "s:moon", "📰": "s:newspaper", "🟢": "s:heartbeat", "🥘": "s:utensils", "🌱": "s:leaf", "🎮": "s:gamepad", "🌤": "s:cloud-sun", "☁": "s:cloud", "🧮": "s:calculator", "⏱": "s:stopwatch", "📅": "s:calendar-day", "📖": "s:book-open", "📄": "s:file-text", "🪵": "s:list-ul", "🐳": "b:docker", "💶": "s:euro-sign", "🌊": "s:water", "🧊": "s:snowflake", "📺": "s:display", "🎵": "s:music", "🛡": "s:shield-halved", "🛒": "s:shopping-cart", "✨": "s:wand-magic-sparkles", "📊": "s:chart-bar", "🐜": "s:receipt", "🚆": "s:train", "📸": "b:instagram", "🖥": "s:computer", "📻": "s:radio", "📡": "s:tower-broadcast", "📦": "s:box", "🗑": "s:trash", "⚙": "s:gear", "✕": "s:xmark", "✓": "s:check", "🍽": "s:utensils", "🔔": "s:bell", "🖼": "s:image", "⭐": "s:star", "🏠": "s:house", "🏷": "s:tag", "👥": "s:users", "🔵": "s:circle", "✅": "s:circle-check", "📃": "s:file", "🔀": "s:shuffle", "📥": "s:download", "🎤": "s:microphone", "🧩": "s:puzzle-piece", "🎉": "s:star", "🔒": "s:lock", "⬆": "s:arrow-up", "🔴": "s:circle", "🚏": "s:bus", "💿": "s:compact-disc", "📋": "s:clipboard", "✗": "s:xmark", "🍳": "s:egg", "🧰": "s:toolbox", "📝": "s:pen-to-square", "📂": "s:folder-open", "📕": "s:book", "☆": "s:star", "🔇": "s:volume-xmark", "🔗": "s:link", "📴": "s:mobile-screen", "⚫": "s:circle", "⚪": "s:circle", "🚉": "s:train", "⛶": "s:expand", "🎼": "s:music", "❓": "s:question", "🚨": "s:bullhorn", "📈": "s:arrow-trend-up", "🎨": "s:palette", "🔐": "s:lock", "🔑": "s:key", "🔈": "s:volume-low", "♪": "s:music", "➕": "s:plus", "📁": "s:folder", "⚠": "s:triangle-exclamation", "🎬": "s:film", "🔍": "s:magnifying-glass", "📶": "s:signal", "📍": "s:location-dot", "🔊": "s:volume-high", "🧺": "s:basket-shopping", "🚫": "s:ban", "🎛": "s:sliders", "🚶": "s:person-walking", "🏦": "s:building-columns", "💳": "s:credit-card", "👤": "s:user", "✏": "s:pencil", "▶": "s:play", "ℹ": "s:circle-info"}};
const OMSUB={"☆": "2B50", "♪": "1F3B5", "✓": "2714", "✕": "274C", "✗": "274C"};
const OMSET=new Set(["1F30A", "1F310", "1F319", "1F324", "1F331", "1F373", "1F37D", "1F389", "1F39B", "1F3A4", "1F3A8", "1F3AC", "1F3AE", "1F3B5", "1F3BC", "1F3E0", "1F3E6", "1F3F7", "1F41C", "1F433", "1F464", "1F465", "1F4B3", "1F4B6", "1F4BE", "1F4BF", "1F4C1", "1F4C2", "1F4C3", "1F4C4", "1F4C5", "1F4C6", "1F4C8", "1F4CA", "1F4CB", "1F4CD", "1F4D5", "1F4D6", "1F4DA", "1F4DD", "1F4E1", "1F4E5", "1F4E6", "1F4F0", "1F4F4", "1F4F6", "1F4F8", "1F4FA", "1F4FB", "1F500", "1F507", "1F508", "1F50A", "1F50D", "1F510", "1F511", "1F512", "1F514", "1F517", "1F534", "1F535", "1F5A5", "1F5BC", "1F5C2", "1F5D1", "1F686", "1F689", "1F68F", "1F6A8", "1F6AB", "1F6B6", "1F6D2", "1F6E1", "1F6F0", "1F7E2", "1F958", "1F9CA", "1F9E9", "1F9EE", "1F9F0", "1F9FA", "1FAB5", "2139", "2328", "23F1", "25B6", "2601", "2699", "26A0", "26AA", "26AB", "2705", "270F", "2714", "2728", "274C", "2753", "2795", "2B06", "2B50"]);
...
const ICON_SET=new Set(Object.keys(ICMAPS.tabler).concat(Object.keys(ICMAPS.bootstrap)).concat(Object.keys(ICMAPS.fa)));
const ICON_RE=/(\u1f3e6)|(\u2713)|(\u1f508)|(\u1f465)|(\u1f534)|(\u1f4dd)|(\u25b6)|(\u1f331)|(\u1f3f7)|(\u1f4c3)|(\u1f512)|(\u1f500)|(\u1f9ee)|(\u2699)|(\u270f)|(\u26ab)|(\u23f1)|(\u2753)|(\u1f510)|(\u2601)|(\u1f50d)|(\u2705)|(\u1f689)|(\u1f4e5)|(\u1f4b6)|(\u2b50)|(\u1f4ca)|(\u1f4bf)|(\u2139)|(\u2715)|(\u1f6b6)|(\u1f5bc)|(\u1f5a5)|(\u1f310)|(\u1f4c6)|(\u1f4da)|(\u1f4f0)|(\u1f4d5)|(\u1f9ca)|(\u1f4f6)|(\u1f7e2)|(\u1f3ae)|(\u266a)|(\u1f4fa)|(\u1f6a8)|(\u1f4e6)|(\u1f3ac)|(\u1f464)|(\u1f4f8)|(\u1f319)|(\u1f4c5)|(\u1f514)|(\u1f50a)|(\u1f4c8)|(\u1f3b5)|(\u2b06)|(\u1f30a)|(\u1f3bc)|(\u1f5d1)|(\u1f4c2)|(\u1f39b)|(\u1f6ab)|(\u2728)|(\u1f4fb)|(\u26a0)|(\u1f3e0)|(\u1f507)|(\u2606)|(\u2328)|(\u1f958)|(\u1f4f4)|(\u1f373)|(\u1f6f0)|(\u1f535)|(\u1f389)|(\u1f3a8)|(\u1f324)|(\u1f68f)|(\u1f5c2)|(\u1f4c1)|(\u1f6e1)|(\u1f9fa)|(\u1f9f0)|(\u1f6d2)|(\u1f511)|(\u2795)|(\u1f4c4)|(\u1f4cd)|(\u1f4e1)|(\u2717)|(\u1f41c)|(\u1f686)|(\u26f6)|(\u1f37d)|(\u1f4cb)|(\u1fab5)|(\u1f9e9)|(\u26aa)|(\u1f517)|(\u1f4be)|(\u1f4d6)|(\u1f3a4)|(\u1f433)|(\u1f4b3)/;
...
function secReglages(){
  ...
  h+='<div class="wsec" style="padding-left:0;margin-top:16px">Saisie</div>'+
    ...
    '<div class="setrow"><div class="lft"><div class="t">URL du store (Abeille)</div><div class="d">Adresse du dépôt d\'addons. Laisse vide pour la valeur par défaut. À renseigner après une réinstallation ou si Abeille change d\'hôte.</div></div><div style="display:flex;flex-direction:column;gap:7px;max-width:340px;width:100%"><input class="inp" id="storeUrlInp" placeholder="https://raw.githubusercontent.com/TheWorms/abeille/main/" value="'+((state.storeUrl||'').replace(/"/g,'&quot;'))+'"><input class="inp" id="storeTokInp" type="password" placeholder="Jeton d\'accès (si dépôt protégé)" value="'+((state.storeToken||'').replace(/"/g,'&quot;'))+'"><div style="display:flex;gap:9px;align-items:center"><button class="btnpill" id="storeUrlTest" type="button">Tester</button><span id="storeUrlRes" style="font-size:12px;color:var(--dim)"></span></div></div></div>'+
